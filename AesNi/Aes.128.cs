...
namespace AesNi
{
    ...
    public static partial class Aes
    {
        ...
        public static void Encrypt(ReadOnlySpan<byte> plaintext, Span<byte> ciphertext, Aes128Key key)
        {
        ...
        public static void Decrypt(ReadOnlySpan<byte> ciphertext, Span<byte> plaintext, Aes128Key key)
        {
            ref var expandedKey = ref MemoryMarshal.GetReference(key.ExpandedKey);
