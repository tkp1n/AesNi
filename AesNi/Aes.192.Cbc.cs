    ...
    public static partial class Aes
    {
            ...
            PaddingMode paddingMode = PaddingMode.Zeros)
        {
            ...
            while (left >= BlockSize)
            {
                ...
                feedback = System.Runtime.Intrinsics.X86.Aes.EncryptLast(feedback, key12);
            ...
            feedback = System.Runtime.Intrinsics.X86.Aes.Encrypt(feedback, key8);
            feedback = System.Runtime.Intrinsics.X86.Aes.Encrypt(feedback, key9);
            feedback = System.Runtime.Intrinsics.X86.Aes.EncryptLast(feedback, key10);
            ...
            PaddingMode paddingMode = PaddingMode.Zeros)
        {
            ...
            while (left >= BlockSize)
            {
                ...
                data = System.Runtime.Intrinsics.X86.Aes.Decrypt(data, key10);
                data = System.Runtime.Intrinsics.X86.Aes.Decrypt(data, key11);
                data = System.Runtime.Intrinsics.X86.Aes.DecryptLast(data, key12);
